...
function ViewportInfo({ precision = 3 }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { className: "mafs-shadow", fontFamily: "monospace", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("text", { x: x + 10, y: y - 70, children: [
      "x: (",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("text", { x: x + 10, y: y - 50, children: [
      "y: (",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("text", { x: x + 10, y: y - 30, children: [
      "xPanes: ",
      xPanesString
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("text", { x: x + 10, y: y - 10, children: [
      "yPanes: ",
      yPanesString
    ] })
  ] });
  ...
  (props, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "g",
      {
        ...
        tabIndex: 0,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { className: "mafs-movable-point-hitbox", r: 30, cx: xPx, cy: yPx }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { className: "mafs-movable-point-ring", r: ringRadiusPx, cx: xPx, cy: yPx }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { className: "mafs-movable-point-point", r: 6, cx: xPx, cy: yPx })
        ]
      }
    );
  }
...
function MovablePoint({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(MovablePointDisplay, { ref, point, color, dragging });
}
...
function useMovablePoint(initialPoint, { constrain, color = Theme.pink } = {}) {
  ...
  const element = React11.useMemo(() => {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(MovablePoint, { ...{ point, color }, constrain: constraintFunction, onMove: setPoint });
...
function Transform(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TransformContext.Provider, { value: { userTransform: newUserTransform, viewTransform }, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("g", { style: { "--mafs-user-transform": vec.toCSS(newUserTransform) }, children }) });
}
...
function Circle({ radius, ...rest }) {
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Ellipse, { radius: [radius, radius], ...rest });
}
...
function Polygon({ svgPolygonProps, ...otherProps }) {
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(PolyBase, { element: "polygon", svgPolyProps: svgPolygonProps, ...otherProps });
}
...
function TransformWidget({ children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(Transform, { translate: t.point, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(Transform, { rotate: angle, children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(Transform, { scale: s.point, children: [
          children,
...
function Mafs({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
    "div",
    {
      ...
      ref: rootRef,
      children: width > 0 && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        MafsCanvas,
        {
          width,
          height,
...
function MafsCanvas({
  ...
  if (typeof zoom === "object") {
    (0, import_tiny_invariant5.default)(zoom.min > 0 && zoom.min <= 1, "zoom.min must be in the range (0, 1]");
    (0, import_tiny_invariant5.default)(zoom.max >= 1, "zoom.max must be in the range [1, \u221E)");
    minZoom = zoom.min;
    maxZoom = zoom.max;
  } else if (zoom) {
    minZoom = 0.5;
  ...
  function mapGesturePoint(point) {
    ...
    (0, import_tiny_invariant5.default)(el, "SVG is not mounted");
    (0, import_tiny_invariant5.default)(inverseViewTransform, "View transform is not invertible");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(CoordinateContext_default.Provider, { value: coordinateContext, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(SpanContext.Provider, { value: { xSpan, ySpan }, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
    TransformContext.Provider,
    {
      value: { userTransform: vec.identity, viewTransform },
      children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(PaneContext_default, { children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
        "svg",
        {
          width,
          height,
          ...
          children: [
            children,
            debug && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
              "rect",
              {
                x: viewBoxX,
                y: viewBoxY,
            ...
            debug && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Debug.ViewportInfo, {})
          ]
        }
      ) })
    }
...
var defaultLabelMaker = (x) => /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
  x,
  x < 0 && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("tspan", { visibility: "hidden", children: "-" })
] });
...
function XLabels({ separation, labelMaker }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("g", { className: "mafs-axis", children: xPanes.map(([min, max]) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("g", { children: snappedRange(min, max, separation).filter((x) => Math.abs(x) > separation / 1e6).map((x) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
    "text",
    {
...
function YLabels({ separation, labelMaker }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("g", { className: "mafs-axis", children: yPanes.map(([min, max]) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("g", { children: snappedRange(min, max, separation).filter((y) => Math.abs(y) > separation / 1e6).map((y) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
    "text",
    {
      x: 5,
...
function Cartesian({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("g", { fill: "none", children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("pattern", { x: 0, y: 0, width: unitW, height: unitH, id, patternUnits: "userSpaceOnUse", children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
        "pattern",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("g", { stroke: "var(--grid-line-subdivision-color)", children: [
            xAxisEnabled !== false && xSubs > 1 && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("line", { x1: 0, y1: 0, x2: 0, y2: subUnitH }),
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("line", { x1: subUnitW, y1: 0, x2: subUnitW, y2: subUnitH })
            ] }),
            yAxisEnabled !== false && ySubs > 1 && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("line", { x1: 0, y1: 0, x2: subUnitW, y2: 0 }),
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("line", { x1: 0, y1: subUnitH, x2: subUnitW, y2: subUnitH })
            ] })
          ] })
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("rect", { width: unitW, height: unitH, fill: `url(#${id}-subdivision)` }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("g", { stroke: "var(--mafs-line-color)", children: [
        yAxisEnabled && xAxis.lines && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("line", { x1: 0, y1: 0, x2: unitW, y2: 0 }),
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("line", { x1: 0, y1: unitH, x2: unitW, y2: unitH })
        ] }),
        xAxisEnabled && yAxis.lines && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("line", { x1: 0, y1: 0, x2: 0, y2: unitH }),
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("line", { x1: unitW, y1: 0, x2: unitW, y2: unitH })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("rect", { x: vxMin, y: vyMax, width: vxMax - vxMin, height: vyMin - vyMax, fill: `url(#${id})` }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("g", { stroke: "var(--mafs-origin-color)", strokeWidth: "var(--mafs-axis-stroke-width)", children: [
      xAxisEnabled && xAxis.axis && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("line", { x1: vxMin, y1: 0, x2: vxMax, y2: 0 }),
      yAxisEnabled && yAxis.axis && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("line", { x1: 0, y1: vyMin, x2: 0, y2: vyMax })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("g", { className: "mafs-shadow", children: [
      xAxisEnabled && xAxis.labels && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(XLabels, { separation: xAxis.lines || 1, labelMaker: xAxis.labels }),
      yAxisEnabled && yAxis.labels && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(YLabels, { separation: yAxis.lines || 1, labelMaker: yAxis.labels })
    ] })
  ] });
}
...
function PolarCoordinates({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("g", { fill: "none", children: [
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("g", { stroke: "var(--grid-line-subdivision-color)", children: thetas.map((theta) => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
      "line",
      {
        x1: 0,
        y1: 0,
    ...
    subRs.map((r) => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
      "ellipse",
      {
        "data-r": r,
        cx: 0,
    ...
    rs.map((r) => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
      "ellipse",
      {
        "data-r": r,
        cx: 0,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("g", { stroke: "var(--mafs-origin-color)", strokeWidth: "var(--mafs-axis-stroke-width)", children: [
      xAxisEnabled && xAxis.axis && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("line", { x1: vxMin, y1: 0, x2: vxMax, y2: 0 }),
      yAxisEnabled && yAxis.axis && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("line", { x1: 0, y1: vyMin, x2: 0, y2: vyMax })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("g", { className: "mafs-shadow", children: [
      xAxisEnabled && xAxis.labels && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
        XLabels,
        {
      ...
      yAxisEnabled && yAxis.labels && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
        YLabels,
        {
...
function OfX({ y, domain, ...props }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(Parametric, { xy, domain: parametricDomain, ...props });
}
...
function OfY({ x, domain, ...props }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Parametric, { xy, domain: parametricDomain, ...props });
}
...
function VectorField({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_jsx_runtime19.Fragment, { children: layers.map((layer, index) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
    "path",
    {
      d: layer.d,
      style: {
...
function Inequality({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("g", { children: [
    ...
    upperBoundType != 0 /* UNBOUNDED */ && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
      "path",
      {
        d: svgPath.upper,
    ...
    lowerBoundType != 0 /* UNBOUNDED */ && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
      "path",
      {
        d: svgPath.lower,
...
function PointAngle({ point, angle, ...rest }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(ThroughPoints, { point1: point, point2, ...rest });
}
...
function PointSlope({ point, slope, ...rest }) {
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(PointAngle, { point, angle: Math.atan(slope), ...rest });
}
...
function Vector({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(import_jsx_runtime27.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("marker", { id, markerWidth: "8", markerHeight: "8", refX: "8", refY: "4", orient: "auto", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("path", { d: "M 0 0 L 8 4 L 0 8 z", fill: color || "var(--mafs-fg)", strokeWidth: 0 }) }) }),
    ...
    "foreignObject",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
        "div",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("span", { ref })
        }
      )
    }
  );
